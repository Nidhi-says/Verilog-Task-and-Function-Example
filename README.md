...
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/f1e24bc4-516d-4778-ac75-c56ed3563e43" />

### **4-bit Ripple Counter using Function**
```verilog
module rca_counter_func(
    input clk,
    input reset,
    output [3:0] q
);
...
module rca_counter_func_tb;
    reg clk, reset;
    wire [3:0] q;

    rca_counter_func uut (
        .clk(clk),
        .reset(reset),
        .q(q)
    );
...
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/65be01a7-9fac-4997-854d-016457fc2808" />
